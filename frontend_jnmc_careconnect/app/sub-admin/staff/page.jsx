...
export default function SubAdminStaffManagement() {
  ...
  // Fetch Sub Admin Profile to get Department
  useEffect(() => {
    ...
    try {
      ...
      if (selectedRole === "doctor") {
        const doctorData = {
          ...
          status: "Active",
          // Department is handled by backend based on logged-in Sub Admin
        };
        response = await addSubAdminDoctor(doctorData);
        ...
        response = await addSubAdminLabEmployee(employeeData);
      }
      ...
      <div className="text-center space-y-4">
        <div>
          ...
          <p className="text-gray-500 font-medium mt-2">
            Add new staff members to your department.
          </p>
        </div>

        {department && (
          <div className="inline-flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-none">
      ...
      <div className="bg-white rounded-none border border-gray-100 p-10 shadow-sm">
        <form className="space-y-8" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 ml-1">
                {selectedRole === "doctor" ? "Doctor ID" : "Employee ID"}
              </label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  disabled
                  className="block w-full pl-11 pr-4 py-4 rounded-none bg-gray-100 border border-transparent text-sm font-bold text-gray-500 cursor-not-allowed"
                />
              </div>
            </div>
